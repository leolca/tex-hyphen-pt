...
% Define a new counter for the custom list of rules
\newcounter{numberRulesGroups}
% Define a new list environment for rules
\newlist{rules}{enumerate}{1}
\setlist[rules,1]{label=\arabic*, ref=\arabic*, before=\setcounter{numberRulesGroups}{0}}
