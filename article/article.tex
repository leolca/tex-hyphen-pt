% xelatex --shell-escape compared.tex 
...
In Portuguese, hyphenations are allowed on syllables boundaries. According to
the Grammar \cite{cunha2016,bergstrom2011}, some rules might still apply:
\begin{enumerate}
